<h2><a href="https://leetcode.com/problems/minimum-suffix-flips/?envType=problem-list-v2&envId=greedy">1529. Minimum Suffix Flips</a></h2><h3>Medium</h3><hr><p>You are given a <strong>0-indexed</strong> binary string <code>target</code> of length <code>n</code>. You have another binary string <code>s</code> of length <code>n</code> that is initially set to all zeros. You want to make <code>s</code> equal to <code>target</code>.</p>
